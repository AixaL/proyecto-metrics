<template>
    <div>
        ...
        <div class="mailings-box ">
            <div class="w-full text-gray-600 font-semibold text-md z-0">
            ...
            <div v-if="visible" v-on:mouseleave="visible=false" class="menu-mailings" style="margin-left:75%" role="menu" aria-orientation="vertical" aria-labelledby="options-menu">
                <ul class="w-full">
                    <li class="li-edit-arch">Editar en stripo <svg class="w-4 h-4 float-right ml-1 self-center" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg></li>
